...
// Listar (admin, gerente e rh) com filtros por empresa e pendentes
router.get('/', autenticar, permitir(['admin', 'administrador', 'gerente', 'rh']), solicitacoesController.listar.bind(solicitacoesController));

// Decidir (aprovar/recusar) - Admin, Gerente e RH
router.put('/:id/decidir', autenticar, permitir(['admin', 'administrador', 'gerente', 'rh']), solicitacoesController.decidir.bind(solicitacoesController));
